          ...
          <Card className="lg:col-span-1 p-6 h-fit">
            <div className="text-center">
              <div className="relative inline-block mb-4">
                <img
                  src="https://images.unsplash.com/photo-1734002886107-168181bcd6a1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBmZW1hbGUlMjBkb2N0b3IlMjBzbWlsaW5nfGVufDF8fHx8MTc3Mzg3Mjc3M3ww&ixlib=rb-4.1.0&q=80&w=1080"
                  alt="Profile"
