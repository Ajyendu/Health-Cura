/**
 * Vercel Routing Middleware: proxies /api/v1/* → BACKEND_ORIGIN (Edge).
 * Use when serverless api/[...path].js is not matched (common with Vite static output).
 * Set BACKEND_ORIGIN in Vercel env (e.g. https://xxx.onrender.com), no /api/v1 suffix.
 */
