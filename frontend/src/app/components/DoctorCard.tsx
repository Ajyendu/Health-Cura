    ...
    >
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="text-xl font-semibold mb-1 truncate">{withDrPrefix(name)}</h3>
      ...
      {/* Action Button */}
      <Link to={`/user/doctor/${id}`} className="block mt-4" onClick={onViewProfile}>
