        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-gray-500">New to HealthCura?</span>
            </div>
          </div>

          {/* Register Link */}
          <Link to="/user/register">
            <Button variant="outline" className="w-full h-12 rounded-xl border-2 border-teal-600 text-teal-600 hover:bg-teal-50">
